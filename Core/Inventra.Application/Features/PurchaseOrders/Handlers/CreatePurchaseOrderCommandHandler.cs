...
namespace Inventra.Application.Features.PurchaseOrders.Handlers
{
    ...
    ISupplierReadRepository _supplierReadRepository,
    IProductReadRepository _productReadRepository,
    IPurchaseOrderWriteRepository _purchaseOrderWriteRepository,
    IUnitOfWork _unitOfWork)
    : IRequestHandler<
        CreatePurchaseOrderCommandRequest,
        Result<CreatePurchaseOrderCommandResponse>>
    {
        public async Task<
            Result<CreatePurchaseOrderCommandResponse>>
            Handle(
                ...
                CancellationToken cancellationToken)
        {
            ...
            if (!supplierExists)
            {
                return Result<CreatePurchaseOrderCommandResponse>
                    .Failure("Supplier not found.");
            }

            foreach (var item in request.Items)
            {
                var productExists =
                    await _productReadRepository
                        .AnyAsync(
            ...
            var purchaseOrder = new PurchaseOrder
            {
                ...
                OrderNumber =
                    $"PO-{DateTime.UtcNow:yyyy}-{Guid.NewGuid().ToString()[..6].ToUpper()}",
            ...
            await _purchaseOrderWriteRepository
            ...
            return Result<CreatePurchaseOrderCommandResponse>
                .SuccessResult(
                    new CreatePurchaseOrderCommandResponse
                    {
                        Id = purchaseOrder.Id
                    },
